...
CONFIG.USE_ELECTRA = confirm("Use UEF to jailbreak (not possible yet)? ");
...
function fail(x) {
    ...
    throw new String('Sileo: Coming Soon iOS 12')
}
...
var pwn = function() {
    ...
    if(CONFIG.USE_ELECTRA) {
        print('UEF cannot be used to jailbreak your device via safari yet.');
    }
